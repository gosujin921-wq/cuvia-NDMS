...
창원특례시를 대상으로 만드는 재난안전관제 데모. 시 전체 조망에서 시작해 지구·센서·CCTV로 좁히고, 경보 이력과 주민 전파를 거쳐 3D 침수 시뮬레이션까지 이어지는 흐름을 화면 5개(SCR-01~05)로 보여준다. 화면 구성은 남해군 조기경보시스템 시연 자료를 기준으로 삼았다. 여기에 다섯 화면이 들고 있는 것을 한 번의 질문으로 모아 오는 AI 검색(SCR-06)을 옆길로 붙였다.
