...
export const DEMO_TICKS: DemoTick[] = [
  ...
  { id: "d7-sent", stage: 7, at: t("17:53"), label: "알림톡·전광판 전파 완료", driver: "세계" },
  { id: "d7-failed", stage: 7, at: t("17:55"), label: "마을방송 실패 · 장비 응답 없음", driver: "세계" },
  { id: "d7-fallback", stage: 7, at: t("17:56"), label: "대체조치 기록 · 유선 연락", driver: "담당자" },
  { id: "d7-escalate", stage: 7, at: t("18:02"), label: "도로수위 침수 기준 지속 · 심각 상향 · SOP 2항목 추가", driver: "세계" },
  { id: "d7-road", stage: 7, at: t("18:06"), label: "해안도로 양방향 통제 완료 · 현장 보고", driver: "세계" },
  { id: "d7-escalate-approve", stage: 7, at: t("18:08"), label: "추가 조치 승인 · 지하차도 진입 통제 · 대피 권고", driver: "담당자" },
  { id: "d7-field", stage: 7, at: t("18:16"), label: "지하차도 진입부 차단 · 현장 확인 완료 · 침수예측판 갱신", driver: "세계" },
  { id: "d7-evac", stage: 7, at: t("18:20"), label: "저지대 대피 안내 완료", driver: "세계" },
  { id: "d7-pump", stage: 7, at: t("18:36"), label: "펌프 2호기 재가동 · 결과 모두 도착", driver: "세계" },
  { id: "d7-control", stage: 7, at: t("18:40"), label: "확대 중단 · 통제 국면", driver: "담당자" },
