...
export const SOP_CATALOG: SopCatalogItem[] = [
  ...
  { id: "SOP-02", label: "담당기관 통보", priority: "MUST", execMode: "자동", chain: "AGENCY", binding: { kind: "auto", completeOn: "approval", detail: "조치 담당 부서에 권고·승인 통보", recipientsFrom: "actions" } },
  { id: "SOP-03", label: "주민 전파 · CAP 문안", priority: "MUST", execMode: "자동", chain: "PUBLIC", binding: { kind: "dissemination" } },
  { id: "SOP-04", label: "해안도로 저지대 구간 통제", priority: "MUST", execMode: "수동", chain: "FIELD", organization: "교통과", binding: { kind: "action", actionKind: "도로 통제", target: "해안도로 저지대 구간" } },
  { id: "SOP-05", label: "제2배수펌프장 2호기 점검·재가동 요청", priority: "MUST", execMode: "수동", chain: "FIELD", organization: "하수과", binding: { kind: "action", actionKind: "시설 점검", target: "제2배수펌프장 2호기", facility: "PS-SH-02" } },
  { id: "SOP-06", label: "신포 지하차도 진입부 현장 확인", priority: "SHOULD", execMode: "수동", chain: "FIELD", organization: "안전총괄과", binding: { kind: "action", actionKind: "현장 확인", target: "신포 지하차도" } },
